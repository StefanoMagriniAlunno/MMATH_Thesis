...
\paragraph{\gls{dada}}
%Nella tesi di ricerca \begin{toDo} inserire riferimento\end{toDo}, le opere pittoriche sono considerate come matrici di colori, e si è definito un $N$-gramma come una sottomatrice quadrata $N \times N$, denominata "tessera".
...
%\indent La ricerca si è concentrata sull'analisi di immagini che sono state ridotte a matrici, nelle quali i soli colori presenti sono il bianco e il nero. Questo processo, noto come "posterizzazione", ha lo scopo di ridurre la quantità di colori presenti nell'opera (nota come "profondità"). Tale scelta metodologica è stata motivata dalla necessità di gestire la dimensione dell'alfabeto; infatti, mentre in un'opera letteraria possono esistere fino a $32^N$ $N$-grammi distinti (considerando le $26$ lettere dell'alfabeto più $6$ simboli di punteggiatura), in un'opera pittorica potrebbero essere presenti $256^{3N}$ tessere distinte con lato $N$. Questa considerevole differenza ha causato delle sfide significative nell'analisi delle immagini, rendendo inefficace l'applicazione di strumenti progettati per le opere letterarie sulle opere pittoriche.
...
%\indent La ricerca ha concluso con risultati incoraggianti, evidenziando che l'analisi automatica dei campioni di calligrafia consente attribuzioni d'autore molto precise. Tuttavia, è emerso che l'applicazione delle stesse analisi su opere pittoriche come vignette e disegni non produce risultati soddisfacenti. Si è ipotizzato che ciò sia dovuto alla natura intrinseca delle opere pittoriche, dove la presenza del colore riveste un importante ruolo, e la posterizzazione, anziché semplificare il processo, genera rumore e nuove informazioni che rendono la rappresentazione dei dati poco affidabile.
