...
def batch_convert_jpg_to_pgm(input_directory, output_directory):
    for dirname, _, filenames in os.walk(input_directory):
        ...
        for filename in filenames:
            if filename.endswith(".jpg"):
                filename_new = filename.replace(".jpg", ".pgm")
...
parser = argparse.ArgumentParser(
    description="This script convert a database of jpg images in a database with pgm images."
)
parser.add_argument(
    "input_directory", type=str, help="Directory di input con i file JPG"
)
parser.add_argument(
...
batch_convert_jpg_to_pgm(input_directory, output_directory)
